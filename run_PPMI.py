...
def run_model_PPMI(feats_type, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    for _ in range(repeat):
        net = MAGNN_nc_mb(n_metapaths, num_edge_type, etypes_list, in_dims, hidden_dim, out_dim, num_heads, attn_vec_dim, rnn_type, dropout_rate)
        net.to(device)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--save-postfix', default='PPMI', help='Postfix for the saved model and result. Default is PPMI.')

    args = ap.parse_args()
    run_model_PPMI(args.feats_type, args.hidden_dim, args.num_heads, args.attn_vec_dim, args.rnn_type,
